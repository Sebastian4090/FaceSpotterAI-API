...
app.get("/profile/:id", requireAuth(redisClient), (req, res) => {
  handleProfileGet(req, res, db);
});
app.post("/profile/:id", requireAuth(redisClient), (req, res) => {
  handleProfileUpdate(req, res, db);
});
app.put("/image", requireAuth(redisClient), (req, res) => {
  handleImage(req, res, db);
});
app.post("/imageurl", requireAuth(redisClient), (req, res) => {
